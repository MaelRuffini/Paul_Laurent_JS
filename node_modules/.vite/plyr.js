...
var getConstructor = (e) => e != null ? e.constructor : null;
var instanceOf = (e, t) => Boolean(e && t && e instanceof t);
var isNullOrUndefined = (e) => e == null;
...
var isElement = (e) => e !== null && typeof e == "object" && e.nodeType === 1 && typeof e.style == "object" && typeof e.ownerDocument == "object";
...
})(), touch: "ontouchstart" in document.documentElement, transitions: transitionEndEvent !== false, reducedMotion: "matchMedia" in window && window.matchMedia("(prefers-reduced-motion)").matches };
...
var standardRatios = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce((e, [t, i]) => __spreadProps(__spreadValues({}, e), { [t / i]: [t, i] }), {});
...
var toTitleCase = (e = "") => e.toString().replace(/\w\S*/g, (e2) => e2.charAt(0).toUpperCase() + e2.substr(1).toLowerCase());
